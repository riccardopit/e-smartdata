'''
The Vehicle and Car classes are listed below. Extend the display_attrs() method in the Car class
so that the following information is displayed before displaying the attributes:
...
year -> 2020
horsepower -> 190
Then create an instance of the class Car named car with the attribute values: 'Tesla', 'black', 2018, 260
