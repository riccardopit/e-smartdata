...
and the RefrigeratedContainer class inherits from TemperatureControlledContainer.
Add a class attribute called temp_range to the TemperatureControlledContainer class
that stores the tuple (-25.0, 25.0), and to the RefrigeratedContainer class
add a class attribute with the same name and value (-25.0, 5.0).
Then, using the getattr() function, read the value of the temp_range attribute of the RefrigeratedContainer class
