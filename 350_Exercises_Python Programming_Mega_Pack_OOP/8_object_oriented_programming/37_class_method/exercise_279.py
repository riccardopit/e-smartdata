'''
Using the @classmethod decorator, implement a class named Container
which has a class method named show_details() displaying the following text to the console:
