...
Using the built-in function isinstance() check whether object1, object2 and object3
are instances of the Model class or of the View class. Print the result to the console.
Expected result:
True
False
False
