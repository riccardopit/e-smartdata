...
Implement the __add__() special method to add (concatenate) Hashtag instances using a space character
as shown below (take into account the appropriate number of '#' characters at the beginning of the new object).
Example:
