...
Then, using the methods get_first_name(), set_first_name(), get_last_name(), set_last_name()
and the property class (do it in the standard way) create properties:
first_name and last_name (properties to read and modify).
