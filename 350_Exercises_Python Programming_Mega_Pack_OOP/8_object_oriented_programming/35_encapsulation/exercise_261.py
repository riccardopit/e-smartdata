...
Then implement methods named get_first_name() and get_last_name(), which reads the protected attributes:
first_name and last_name.
Then, using the get_first_name() and get_last_name() methods and the property class (do it in the standard way)
create two properties named first_name and last_name (read-only properties).
