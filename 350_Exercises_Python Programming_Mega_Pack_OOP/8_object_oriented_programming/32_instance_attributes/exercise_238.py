...
Then a books list was created. Create a loop to list all the attributes of the book_1 and book_2 instances
with their values as shown below (separate each instance with a line of 30 '-' characters  as shown below).
Expected result:
author -> Dan Brown
title -> Inferno
------------------------------
