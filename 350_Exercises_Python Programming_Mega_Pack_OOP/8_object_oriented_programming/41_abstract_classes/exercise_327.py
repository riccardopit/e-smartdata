...
Create a class derived from the TaxPayer class named DisabledTaxPayer that implements the calculate_tax()
method that calculates the minimum value of the following two:
...
disabled_tax_payer = DisabledTaxPayer(50000)
print(disabled_tax_payer.calculate_tax())
