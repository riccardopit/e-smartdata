...
Create a class derived from the TaxPayer class named WorkerTaxPayer that implements the calculate_tax() method
that calculates the tax value according to the rule:
